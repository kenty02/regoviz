...
export type GetRulesQueryResult = NonNullable<
	Awaited<ReturnType<typeof getRules>>
>;
export type GetRulesQueryError = AxiosError<unknown>;
...
>(options?: {
	query?: Partial<
		UseSuspenseQueryOptions<Awaited<ReturnType<typeof getRules>>, TError, TData>
	>;
	axios?: AxiosRequestConfig;
}) => {
	const { query: queryOptions, axios: axiosOptions } = options ?? {};
...
export type GetRulesSuspenseQueryResult = NonNullable<
	Awaited<ReturnType<typeof getRules>>
>;
export type GetRulesSuspenseQueryError = AxiosError<unknown>;

export const useGetRulesSuspense = <
	TData = Awaited<ReturnType<typeof getRules>>,
	TError = AxiosError<unknown>,
>(options?: {
	query?: Partial<
	...
	const queryOptions = getGetRulesSuspenseQueryOptions(options);
...
export const getGetRulesSuspenseInfiniteQueryOptions = <
	TData = InfiniteData<Awaited<ReturnType<typeof getRules>>>,
	TError = AxiosError<unknown>,
>(options?: {
	query?: Partial<
		UseSuspenseInfiniteQueryOptions<
...
export type GetRulesSuspenseInfiniteQueryResult = NonNullable<
	Awaited<ReturnType<typeof getRules>>
>;
export type GetRulesSuspenseInfiniteQueryError = AxiosError<unknown>;

export const useGetRulesSuspenseInfinite = <
	TData = InfiniteData<Awaited<ReturnType<typeof getRules>>>,
	TError = AxiosError<unknown>,
>(options?: {
	query?: Partial<
	...
	const queryOptions = getGetRulesSuspenseInfiniteQueryOptions(options);
